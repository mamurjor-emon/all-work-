<template>
    ...
    <section class="section-hero">
      ...
      <div class="hero">
        ...
        >
          ...
          <a href="#" class="btn btn--fill margin-right-btn">Start eating well </a>
          <a href="#" class="btn btn--outline margin-right-btn">Learn more &darr; </a>
        </div>
        <div
          class="hero-img-box"
          data-aos="fade-right"
  ...
  <div>
    <section data-aos="fade-up" class="section-hero">
      <!-- 1.  Now we need to make our hero section display grid and need to center the content in the page.
